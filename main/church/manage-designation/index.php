...
<head>
    ...
    <title>Super Admin | Manage Designation</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-sm bg-success float-right" onclick="addDesignation()"><span class="fa fa-plus"></span> Add Designation</button>
                            </div>
                            <div class="card-body">
                                <div id="manage-designation-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Modals -->
    <!-- Manage Designation Modals -->
    <div class="modal fade" id="manage-designation-add-edit-designation-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="manage-designation-add-edit-designation-modal-title">Create New Designation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="clearAddEditDesignationModal()">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="designation-name" class="col-form-label">Designation Name:</label>
                            <input type="text" class="form-control" id="designation-name">
                        </div>
                        <div class="form-group">
                            <label for="designation-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="designation-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-designation-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="clearAddEditDesignationModal()">Close</button>
