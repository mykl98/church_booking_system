...
<head>
    ...
    <title>Super Admin | Manage Units</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-sm bg-success float-right" onclick="addUnit()"><span class="fa fa-plus"></span> Add Unit</button>
                            </div>
                            <div class="card-body">
                                <div id="manage-unit-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Modals -->
    <div class="modal fade" id="add-edit-unit-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-unit-modal-title">Create New Unit</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="clearAddEditUnitModal()">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="unit-status" class="col-form-label">Status:</label>
                    ...
                    <p id="add-edit-unit-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="clearAddEditUnitModal()">Close</button>
