...
<head>
    ...
    <title>Super Admin | Manage Department</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Manage Departments</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-sm bg-success float-right" onclick="addDepartment()"><span class="fa fa-plus"></span> Add Department</button>
                            </div>
                            <div class="card-body">
                                <div id="manage-department-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
